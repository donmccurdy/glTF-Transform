...
| [metalRough](https://github.com/donmccurdy/glTF-Transform/tree/master/packages/lib/src/metalrough.ts)       | Node.js, Web  | Convert materials from spec/gloss to metal/rough. |
