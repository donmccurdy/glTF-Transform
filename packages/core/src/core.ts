...
export { Accessor, Animation, AnimationChannel, AnimationSampler, Buffer, Camera, Property, Material, Mesh, Node, Primitive, Root, Scene, Skin, Texture, TextureInfo, TextureSampler } from './properties';
