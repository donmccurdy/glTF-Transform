...
import { PMREMGenerator, REVISION, type Texture, WebGLRenderer } from 'three';
...
export function createGLTFLoader() {
	...
	const loader = new GLTFLoader().setMeshoptDecoder(MeshoptDecoder).setKTX2Loader(createKTX2Loader());
